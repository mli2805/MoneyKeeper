...
{
    public class TransactsEditExecutor
    {
        ...
        public TransactsEditExecutor(TransactsModel model, IWindowManager windowManager,
        ...
        private void AddOneTranAndReceipt(OneTranViewModel oneTranForm)
        {
            ...
            var sameDayTransactions = 
                _dataModel.Transactions.Values.Where(t => t.Timestamp.Date == oneTran.Timestamp.Date).ToList();
