...
namespace Keeper2018
{
    ...
    public partial class DateSelectControl
    {
        public static readonly DependencyProperty SelectedDayProperty =
               ...
               typeof(DateSelectControl), new FrameworkPropertyMetadata(new DateTime()));
        ...
        public static readonly DependencyProperty ChangeControlTypeEventProperty =
              ...
              typeof(DateSelectControl), new FrameworkPropertyMetadata(new bool()));

        public bool ChangeControlTypeEvent
        {
            get => (bool)GetValue(ChangeControlTypeEventProperty);
