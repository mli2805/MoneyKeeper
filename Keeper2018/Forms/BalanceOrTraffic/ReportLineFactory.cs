...
namespace Keeper2018
{
    ...
    {
        public static ReportLine ReportLine(this KeeperDataModel dataModel, Balance before, TransactionModel tran, bool isInReturn, int sign, DepositOperationType type)
        {
        ...
        public static ReportLine ReportLineOneAccountExchange(this KeeperDataModel dataModel, Balance before, TransactionModel tran)
        {
            var line = new ReportLine();
            line.Date = tran.Timestamp.Date;
            line.Before = before;
