...
namespace Keeper2018
{
    ...
    {
        public static string ShortLine(this KeeperDataModel dataModel, Transaction tran, bool isInReturn, int sign)
        {
        ...
        public static string ShortLine(this KeeperDataModel dataModel, Transaction tran, bool isInReturn, int sign, out decimal inUsd)
        {
            var amount = isInReturn ? tran.AmountInReturn : tran.Amount;
            var currency = isInReturn ? tran.CurrencyInReturn : tran.Currency;
        ...
        public static string ShortLineOneAccountExchange(this KeeperDataModel dataModel, Transaction tran)
        {
